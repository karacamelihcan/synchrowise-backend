                ...
                if (context != null)
                {
                    ...
                    if (group != null)
                    {
                       ...
                       /* Dictionary<string, object> data = new Dictionary<string, object>();
                        ...
                        await Clients.Group(group.Guid.ToString()).SendAsync("JoinedGroup", user,group.Guid);
                    }
                    else{
                        await Clients.Group(group.Guid.ToString()).SendAsync("JoinGroupError","There is no such a group");
                    }
                }
                else{
